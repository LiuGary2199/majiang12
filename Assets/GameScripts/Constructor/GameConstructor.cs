...
namespace Mkey
{
    ...
    public class GameConstructor : MonoBehaviour
    {
        ...
        [SerializeField]
        private GridObject currentBrush; // 当前画刷对象
        [SerializeField]
        ...
        [Header("Grid", order = 1)]
        [SerializeField]
        private PanelContainerController GridPanelContainer; // 网格面板容器
        [SerializeField]
        private IncDecInputPanel IncDecGridPrefab; // 增减输入面板预制体
        ...
        private MatchGrid MGrid { get { return MBoard.MainGrid; } } // 主网格
        ...
        public Action<GridObject, int> AddTileAction { get; set; } // 添加对象事件
