...
/// 矩形遮罩镂空
/// </summary>
public class FleeFlintMite : MonoBehaviour
{
    public static FleeFlintMite instance;
[UnityEngine.Serialization.FormerlySerializedAs("Hand")]    public GameObject Bark;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    public void Volt(GameObject _target)
    {
        ...
        else
        {
            ...
            float width = 1;
            float height = 1;
            Auction[0] = new Vector3(pos.x - width, pos.y - height);
            Auction[1] = new Vector3(pos.x - width, pos.y + height);
            Auction[2] = new Vector3(pos.x + width, pos.y + height);
            Auction[3] = new Vector3(pos.x + width, pos.y - height);
        }
        //计算高亮显示区域在画布中的范围
