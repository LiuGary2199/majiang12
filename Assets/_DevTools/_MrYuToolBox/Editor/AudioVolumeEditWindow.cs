...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    Dictionary<string, HeaveFaith> UIAudioGroup;
    Dictionary<string, HeaveFaith> SceneAudioGroup;
    //序列化对象
    ...
    {
        UIAudioGroup = new Dictionary<string, HeaveFaith>();
        SceneAudioGroup = new Dictionary<string, HeaveFaith>();
        ...
        Dictionary<string, HeaveFaith> audioDic = new Dictionary<string, HeaveFaith>();
        if (FileInfo.Exists)
        {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(PanelRate.UIMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            HeaveFaith model = new HeaveFaith();
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(PanelRate.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            HeaveFaith model = new HeaveFaith();
    ...
    public Dictionary<string, HeaveFaith> LoadJson(string Filepath)
    {
        StreamReader reader = new StreamReader(Filepath);
        string jsonString = reader.ReadToEnd();
        Dictionary<string, HeaveFaith> audioGroup = JsonMapper.ToObject<Dictionary<string, HeaveFaith>>(jsonString);
        reader.Dispose();
        reader.Close();
        return audioGroup;
    }
    ...
    {
        Dictionary<string, HeaveFaith> dic = new Dictionary<string, HeaveFaith>();
        MergeDictionaries.Amino(dic, UIAudioGroup);
        MergeDictionaries.Amino(dic, SceneAudioGroup);
