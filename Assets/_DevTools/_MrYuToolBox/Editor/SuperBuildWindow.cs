...
public class SuperBuildWindow : UnityEditor.EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Label("域名:" + info.ComeCow);
        ...
        if (info.DesState == "DES")
        {
            ...
            {
                info.DesState = "STR";
                info.Applovin_SDK_KEY = OwnRegretLoom.MixtureDES(info.Applovin_SDK_KEY);
        ...
        else
        {
            ...
            {
                info.DesState = "DES";
                info.Applovin_SDK_KEY = OwnRegretLoom.ImitateDES(info.Applovin_SDK_KEY);
